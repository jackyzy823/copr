...
%global crate yaxpeax-x86

Name:           rust-yaxpeax-x86
Version:        2.0.0
Release:        %autorelease
Summary:        X86 decoders for the yaxpeax project

License:        0BSD
URL:            https://crates.io/crates/yaxpeax-x86
...
%package     -n %{name}+capstone_bench-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+capstone_bench-devel %{_description}

This package contains library source intended for building other packages which
use the "capstone_bench" feature of the "%{crate}" crate.

%files       -n %{name}+capstone_bench-devel
%ghost %{crate_instdir}/Cargo.toml
