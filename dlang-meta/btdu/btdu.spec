## Reference: https://github.com/terrapkg/packages/blob/f794351643eed3dbf89441c1c335f7e6734d40ba/anda/langs/d/btdu/btdu.spec
## Difference 1) Not using pkgconfig(ncurses) 2) Offline dependencies 3) code.dlang.org SOURCE
%global _version    0.6.0
## find-debuginfo: gdb-add-index -> ../../gdb/utils.c:671: internal-error: virtual memory exhausted.
%global debug_package %nil
%global _buildtype  release
...
Source:         %{dub_source ae 0.0.3461}
Source:         %{dub_source btrfs 0.0.21}
Source:         %{dub_source ncurses 1.0.0}
Source:         %{dub_source emsi_containers 0.9.0}

BuildRequires:  dub
BuildRequires:  ldc
# https://github.com/CyberShadow/btdu/blob/master/README.md#building
...
install -Dpm0644 -t %{buildroot}%{_mandir}/man1 %{name}.1
