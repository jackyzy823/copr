...
%endif
%if 0%{?fedora}
%global bpf_targets bpfeb-unknown-none bpfel-unknown-none
%endif
...
%endif
%endif
%global all_targets %{?bpf_targets} %{?mingw_targets} %{?wasm_targets} %{?extra_targets}
...
%if %target_enabled bpfeb-unknown-none
%target_package bpfeb-unknown-none
BuildArch:      noarch
%target_description bpfeb-unknown-none eBPF
%endif

%if %target_enabled bpfel-unknown-none
%target_package bpfel-unknown-none
BuildArch:      noarch
%target_description bpfel-unknown-none eBPF
%endif
...
(
  ...
  # since bpf_targets don't support standard library so don't test it
...
%if %target_enabled bpfeb-unknown-none
%target_files bpfeb-unknown-none
%endif

%if %target_enabled bpfel-unknown-none
%target_files bpfel-unknown-none
%endif
