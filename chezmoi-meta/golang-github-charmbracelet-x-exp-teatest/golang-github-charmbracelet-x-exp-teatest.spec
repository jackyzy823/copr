...
%global module          exp/teatest
%global goipath         github.com/charmbracelet/x/%{module}
Version:                0
%global commit          83e3a29d542fe292a3bd0a965079ea16a432bcda
...
## todo make exp variables
find . -mindepth 1 -maxdepth 1 -type d  -not -name exp -not -name _build  -exec rm -rf {} \;
