...
%global goipath         github.com/minio/minlz
Version:                1.0.1
...
Name:           golang-github-minio-minlz
Release:        %autorelease
Summary:        MinLZ is a LZ77 compressor, focused on realtime data compression
...
%if %{without bootstrap}
%build
for cmd in cmd/internal/* ; do
  %gobuild -o %{gobuilddir}/bin/$(basename $cmd) %{goipath}/$cmd
done
%gobuild -o %{gobuilddir}/bin/$(basename cmd/mz) %{goipath}/cmd/mz
#for cmd in _generate; do
#  %gobuild -o %{gobuilddir}/bin/$(basename $cmd) %{goipath}/$cmd
#done
%endif
