...
%global crate unicode-id-start

Name:           rust-unicode-id-start
Version:        1.3.1
Release:        %autorelease
Summary:        Determine whether characters have the ID_Start or ID_Continue properties according to Unicode Standard Annex #31

License:        (MIT OR Apache-2.0) AND Unicode-DFS-2016
URL:            https://crates.io/crates/unicode-id-start
