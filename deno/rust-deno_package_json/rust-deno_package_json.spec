...
%global crate deno_package_json

Name:           rust-deno_package_json
Version:        0.1.2
Release:        %autorelease
Summary:        Package.json implementation for the Deno CLI

License:        MIT
URL:            https://crates.io/crates/deno_package_json
